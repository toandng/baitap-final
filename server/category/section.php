...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['msv'])) {
        ...
        $msv = $_POST['msv'];
        $sql = "SELECT * FROM tbl_lophocphan WHERE `Mã lớp` = ?";
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <h3 class="text-center">Tra Cứu Lớp học phần</h3>

            <!-- Form nhập Mã lớp -->
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="mt-4">
                <div class="mb-3">
                    <label for="msv" class="form-label">Mã lớp học phần</label>
                ...
                <table class="table table-bordered table-hover mt-4">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($studentData['Mã học phần']); ?></td>
                            <td><?php echo htmlspecialchars($studentData['nhóm']); ?></td>
                            <td><?php echo htmlspecialchars($studentData['học kì']); ?></td>
                            <td><?php echo htmlspecialchars($studentData['năm học']); ?></td>
                        </tr>
                    </tbody>
                </table>
            <?php endif; ?>
